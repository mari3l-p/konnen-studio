...
export default function ActualizarContrasena() {
  ...
  async function handleUpdatePassword(e: React.FormEvent) {
    ...
    // Al llegar desde el enlace del correo, el usuario ya tiene una sesión temporal.
    // updateUser detecta esa sesión y cambia la contraseña.
    ...
    if (error) {
      ...
      setSuccess(true)
      // Esperamos 2 segundos para que el usuario lea el mensaje de éxito y lo mandamos al dashboard
      setTimeout(() => {
